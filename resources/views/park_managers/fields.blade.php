...
<div class="row">
    ...
    <div class="form-group col-sm-6 {{ $errors->has('middlename') ? 'has-error' : ''}}">
        {!! Form::label('middlename', 'Middlename:',['class' => 'col-sm-6 control-label']) !!}
        <div class="col-sm-12">
...
<div class="row">
    ...
    <div class="form-group col-sm-6 {{ $errors->has('maiden_name') ? 'has-error' : ''}}">
        {!! Form::label('maiden_name', 'Mothers Maiden Name:',['class' => 'col-sm-4 control-label']) !!}
        <div class="col-sm-12">
...
<div class="row">
    ...
    <div class="form-group col-sm-6 {{ $errors->has('origin') ? 'has-error' : ''}}">
        {!! Form::label('origin', 'State Of Origin:',['class' => 'col-sm-4 control-label']) !!}
        <div class="col-sm-12">
